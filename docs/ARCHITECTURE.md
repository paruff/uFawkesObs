...
|---|---|---|---|---|
| `otel-collector` | `otel/opentelemetry-collector-contrib` | 0.103.1 | 4317 (gRPC), 4318 (HTTP), 8888 (self-metrics), 8889 (Prometheus exporter) | Receives OTLP telemetry, routes metrics → Prometheus, traces → Tempo, logs → Loki |
